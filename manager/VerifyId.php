...
class VerifyId
{
    ...
    public function getCommentTrousseId()
    {
        if (array_key_exists('id',$_GET))
        {
            if (!empty($_GET['id']))
            {
                if (ctype_digit($_GET['id']))
                {
                    ...
                    $commentTrousse = $commentTrousseManager->getComment($_GET['id']);
                    if ($commentTrousse == TRUE)
                    {
                        return $commentTrousse;
                    }
                    else
                    {
                        $req = new FlashMessageSession();
    ...
    public function getAddCommentTrousseId()
    {
        if (array_key_exists('id',$_GET))
        {
            if (!empty($_GET['id']))
    ...
    public function getArticleId()
    {
            if (array_key_exists('id',$_GET))
        {
            ...
            else
            {
                $req = new FlashMessageSession();
                $flash = $req->asMessage();
                $flash = $req->setFlash('L\'identifiant d\'un article ne peut être vide');
                header('Location: index.php');
                exit();
            }
        }
